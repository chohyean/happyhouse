		...
		<b-navbar toggleable="lg" type="light" variant="light">
			...
			<b-collapse id="nav-collapse" is-nav>
				<b-navbar-nav>
					...
					>
					<b-nav-item href="#"
						><router-link :to="{ name: 'house' }" class="link">매물정보</router-link></b-nav-item
					>
					<b-nav-item href="#"
				...
				<b-navbar-nav class="ml-auto" v-if="userInfo">
					<b-nav-item class="align-self-center"
						><b-avatar class="login-avatar" variant="secondary" size="sm"></b-avatar
						>{{ userInfo.name }}님 환영합니다.</b-nav-item
					>
					<b-nav-item href="#" @click.prevent="logout()">로그아웃</b-nav-item>
					<b-nav-item href="#"
						><router-link :to="{ name: 'info' }" class="link">회원정보</router-link></b-nav-item
					>
				</b-navbar-nav>
