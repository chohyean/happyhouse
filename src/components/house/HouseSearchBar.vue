		...
		displayInfowindow(marker, title, place) {
          ...
          <div">
              ...
              <ul>
                  <li>
                      <span>건축년도</span>
                      <span>${place.buildYear}</span>
                  </li>
                  <li>
                      <span>주소</span>
                      <span>${place.gugunName} ${place.dongName} ${place.jibun}</span>
                  </li>
                  <li>
                      <span>최신거래금액</span>
                      <span>${place.recentPrice}</span>
                  </li>
              </ul>
          </div>
      `;
